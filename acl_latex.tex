...
\begin{figure}[t!]
  \includegraphics[width=\columnwidth]{figures/teaser_v2.drawio-1.pdf}
...
clusters the 32 source modules into 30 functional nodes as shown in Figure \ref{fig:archpqa} rather than emitting one node per file. All values are reproducible from the persisted graph and critic
