...
The LLM scoring protocol (temperature 0, up to three retries, and one judge family for metric scores, P1/P3 proxy labels, and design-quality axes) is stated in Section~\ref{sec:evaluation_axes}. Judge-family alignment bias is discussed in Section~\ref{sec:limitations}.
