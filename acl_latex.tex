...
Because every Litmus metric is conditioned on the recovered component graph, we check that graph rather than assume it. On scientific QA, Litmus recovers a 30-node graph that is 65\% edge-verified, with no phantom modules (Appendix~\ref{app:arch}). 
